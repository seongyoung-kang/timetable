...
${'site_srl289_argument'} = new ConditionArgument('site_srl', $args->site_srl, 'equal');
${'site_srl289_argument'}->checkNotNull();
${'site_srl289_argument'}->createConditionValue();
if(!${'site_srl289_argument'}->isValid()) return ${'site_srl289_argument'}->getErrorMessage();
if(${'site_srl289_argument'} !== null) ${'site_srl289_argument'}->setColumnType('number');
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl289_argument,"equal")))
));
